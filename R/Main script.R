...
SN.1 <-  sprintf('%s in <a href="%s" target= "_blank">%s</a> and <a href="%s" target= "_blank">%s</a>',
                 SectoralNAPs$`1 Sectoral NAP Title `,
...
SN.2 <-  sprintf('%s in <a href="%s" target= "_blank">%s</a> and <a href="%s" target= "_blank">%s</a>',
                 SectoralNAPs$`2 Sectoral NAP Title `,
...
SN.3 <-  sprintf('%s in <a href="%s" target= "_blank">%s</a> and <a href="%s" target= "_blank">%s</a>',
                 SectoralNAPs$`3 Sectoral NAP Title `,
...
SN.4 <-  sprintf('%s in <a href="%s" target= "_blank">%s</a>',
                 SectoralNAPs$`4 Sectoral NAP Title `,
                 SectoralNAPs$`4 Sectoral NAP Link 1`,
                 SectoralNAPs$`4 Sectoral NAP Language 1`
                 )
SN.5 <-  sprintf('%s in <a href="%s" target= "_blank">%s</a>',
                 SectoralNAPs$`5 Sectoral NAP Title `,
...
NAPssubmitted <- NAPssubmitted %>% mutate(`NAP Language` = NAP.language1,
  ...
  select(Country, Region, Type, `LLDC or SIDS`, `Date Posted`, `NAP Language`, `NAP Language 2`)
